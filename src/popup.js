document.getElementById('saveHtml').addEventListener('click', () => {
  ...
  const signer = new ethers.Wallet("TESTING", provider); // NEVER hard-code private keys in production
  ...
  const contractAddress = "0x977A8c6416Ce067a2da27d67129cc47Dd6e78E23";

  const contract = new ethers.Contract(contractAddress, contractABI, signer);

  // Call a function that modifies the contract's state
  async function modifyContractData() {
      const tx = await contract.mintNFT("0xe3b27BbaCE58F3Ec42C0F43901Db7bB322d5582a", JSON.stringify({"name": "Permanant Record","description": "Post stored on Permanant Record","image": "INSERT_TREE_IMAGE","attributes": [{"trait_type": "Link","value": "INSERT_LINK_HERE"}, {"trait_type": "Timestamp","value": "INSERT_TIMESTAMP_HERE"}]}), { gasLimit: 1000000 });
