  ...
  chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
    ...
    chrome.pageCapture.saveAsMHTML({ tabId: currentTab.id }, (mhtmlData) => {
      ...
      reader.onload = async function(event) { 
        ...
        globalMhtmlString = encodedString;
        await mintPost();
      };
...
async function mintPost() {
  ...
  const contractAddress = "0x71ce3f8F0ddfE9A004fF2ac170705c831f3008E7";

  const contract = new ethers.Contract(contractAddress, contractABI, signer);

  async function modifyContractData() {
      const tx = await contract.mintNFT("0xe3b27BbaCE58F3Ec42C0F43901Db7bB322d5582a", JSON.stringify({"name": globalTabUrl,"description": "Post stored on Permanant Record","image": "https://www.thespruce.com/thmb/DBRIbI_OyMN1johxj1fJYSO_D0g=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/twelve-species-cultivars-of-birch-trees-3269660-03-298049dbff4c431f86b5fdd2728816a8.jpg","attributes": [{"trait_type": "MHTML","value": globalMhtmlString.substring(0, 300)}, {"trait_type": "Timestamp","value": Math.floor(Date.now() / 1000)}]}), { gasLimit: 1000000 });
      await tx.wait(); 
